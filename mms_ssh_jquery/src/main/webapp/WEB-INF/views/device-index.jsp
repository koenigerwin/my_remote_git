...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/js/kindeditor-4.1.10/themes/default/default.css" >
<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/kindeditor-4.1.10/kindeditor-all-min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/kindeditor-4.1.10/lang/zh_CN.js"></script>
    ...
    <div data-options="region:'west',title:'菜单',split:true" style="width:180px;">
    	<ul id="menu" class="easyui-tree" style="margin-top: 10px;margin-left: 5px;">
         	<li>
         		<span>设备管理</span>
         		<ul>                                 
	         		<li data-options="attributes:{'url':'${pageContext.request.contextPath}/bm/device/device-add'}">新增设备</li>
	         		<li data-options="attributes:{'url':'${pageContext.request.contextPath}/bm/device/device-list'}">查询设备</li>
