...
<script src="${cp}/static/js/ligerUI/lib/ligerUI/js/ligerui.all.js" type="text/javascript"></script>
...
<script type="text/javascript">
	...
	$(function() {
		...
		//树
		e = $("#tree1").ligerTree({
			url : '${cp}/menuMain/getAllDirs?' + $.param({
				typeid : '1',
				parentid : '0',
				child : '1'
			}),
	...
	var skin_links = {
		"aqua" : "static/lib/ligerUI/skins/Aqua/css/ligerui-all.css",
		"gray" : "static/lib/ligerUI/skins/Gray/css/all.css",
		"silvery" : "static/lib/ligerUI/skins/Silvery/css/style.css",
		"gray2014" : "static/lib/ligerUI/skins/gray2014/css/all.css"
	};
	function pages_init() {
...
.l-topmenu {
	...
	height: 31px;
	line-height: 31px;
	background: url('${cp}/static/js/ligerUI/lib/images/top.jpg') repeat-x bottom;
	position: relative;
...
.l-topmenu-logo {
	...
	padding-left: 35px;
	line-height: 26px;
	background: url('${cp}/static/js/ligerUI/lib/images/topicon.gif') no-repeat 10px 5px;
}
	...
	<div id="layout1"
		...
		<div position="center" id="framecenter">
			<div tabid="home" title="我的主页" style="height: 300px">
				<iframe frameborder="0" name="home" id="home" src="main.htm"></iframe>
			</div>
		</div>

	</div>
	<div style="height: 32px; line-height: 32px; text-align: center;">
		Copyright © 2011-2014 www.clps.com</div>
