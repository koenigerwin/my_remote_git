...
<title>Insert title here</title>
   ...
   // alert(eval(${request.roleStr}).roleName);
        $(function (){
            var a=${roleStr}.roleName;
            var b=${roleStr}.roleIcon;
            var c=${roleStr}.roleDescription;
        	$("#roleName").val(a);
        	$("#roleIcon").val(b);
        	$("#roleDescription").val(c);
            ...
            $("#Button1").click(function(){
            	 $.ajax({
                 	url:'role_update',
                 	data:{"roleId":${roleStr}.roleId,"roleName":$("#roleName").val(),"roleIcon":$("#roleIcon").val(),"roleDescription":$("#roleDescription").val()},
